...
<<<<<<< HEAD
  ...
  return (
    ...
    <Button
              ...
              style={{ backgroundColor: "greenyellow", color: 'black', position: 'fixed', marginLeft: '500px' }}
            >
              Logout
            </Button>
      <Box
...
<Box
      ...
      >
        ...
        >
          ...
          >
<<<<<<< HEAD
            <Input type="text" disableUnderline value={data.info.name} readOnly sx={{borderBottom:'2px solid gray',color:'white'}}/>
